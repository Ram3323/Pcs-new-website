...
const Services = () => {
  ...
  const [direction, setDirection] = useState('right'); // Track direction of slide
  ...
  const handleDotClick = (index) => {
    ...
    setCurrentIndex(index * (isMobile ? 1 : itemsPerPage));
  };
    ...
    <div>
      ...
      <div className="min-h-screen bg-white overflow-hidden">
        <div className="flex flex-wrap p-8 md:p-24 lg:flex-nowrap lg:space-x-8 flex-col lg:flex-row">
          ...
          >
            <div
              className={`flex p-4 space-x-4 transform transition-transform duration-1000 ease-in-out ${
