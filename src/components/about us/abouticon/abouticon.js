...
const AboutIcon = () => {
  ...
  return (
    <div className="py-8 sm:py-16 overflow-hidden">
      {/* Heading */}
      <h2 className="text-2xl sm:text-3xl font-medium text-center mb-6 sm:mb-12 font-marko">
        All Of We Are
      </h2>
      ...
      <div className="relative flex items-center">
        <div className="flex animate-marquee">
          ...
          {repeatedFeatures.map((feature, index) => (
            <div
              key={index}
              className="flex flex-col items-center mx-4 sm:mx-8 text-center w-[120px] sm:w-[180px] shrink-0"
            >
              <div className="mb-2 sm:mb-4 text-gray-400">{feature.icon}</div>
              <p className="text-sm sm:text-lg text-gray-600 font-medium font-markazi">
                {feature.title}
              </p>
            </div>
          ))}
